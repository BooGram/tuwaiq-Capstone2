...
public class ClothingOrderController {
    ...
    public ResponseEntity<?> createClothingOrder(@PathVariable Integer customerId, @RequestBody @Valid ClothingOrder clothingOrder) {
        clothingOrderService.createClothingOrder(customerId, clothingOrder);
        return ResponseEntity.status(200).body(new ApiResponse("Clothing order created successfully"));
    }

    @PutMapping("/update/{customerId}/{id}")
    public ResponseEntity<?> updateClothingOrder(@PathVariable Integer customerId, @PathVariable Integer id, @RequestBody @Valid ClothingOrder clothingOrder) {
        clothingOrderService.updateClothingOrder(customerId, id, clothingOrder);
